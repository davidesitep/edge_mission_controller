...
import commandvel_pb2 as commandvel__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in commandvel_pb2_grpc.py depends on'
...
class CommandVelBridgeServiceStub(object):
...
def add_CommandVelBridgeServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'CommandVelBridge.CommandVelBridgeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('CommandVelBridge.CommandVelBridgeService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class CommandVelBridgeService(object):
    """Missing associated documentation comment in .proto file."""
